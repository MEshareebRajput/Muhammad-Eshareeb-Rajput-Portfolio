...
const ChatBot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { 
      role: 'model', 
      text: `Hello! I'm ${PERSONAL_INFO.name}'s AI assistant. I can tell you about his expertise in WordPress, Shopify, and Digital Marketing. Try asking: "What was your role at Marcos Technology?"` 
    }
  ]);
